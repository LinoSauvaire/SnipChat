...
RegisterServerAction("searchUsers")
RegisterServerAction("sendFriendRequest")
RegisterServerAction("listFriendRequests")
RegisterServerAction("respondFriendRequest")
RegisterServerAction("captureStory")
RegisterServerAction("listConversations")
RegisterServerAction("listMessages")
